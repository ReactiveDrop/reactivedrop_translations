...
var achievements = [...]achievementData{
	...
	// {, , "RD_SPEEDRUN_BONUS_SPC"},
	// {, , "RD_SPEEDRUN_BONUS_RAPTURE"},
	// {, , "RD_SPEEDRUN_BONUS_BUNKER"},
	// {, , "RD_EASY_CAMPAIGN_ACC"},
	// {, , "RD_NORMAL_CAMPAIGN_ACC"},
	// {, , "RD_HARD_CAMPAIGN_ACC"},
	// {, , "RD_INSANE_CAMPAIGN_ACC"},
	// {, , "RD_IMBA_CAMPAIGN_ACC"},
	// {, , "RD_SPEEDRUN_ACC_INFODEP"},
	// {, , "RD_SPEEDRUN_ACC_POWERHOOD"},
	// {, , "RD_SPEEDRUN_ACC_RESCENTER"},
	// {, , "RD_SPEEDRUN_ACC_CONFACILITY"},
	// {, , "RD_SPEEDRUN_ACC_J5CONNECTOR"},
	// {, , "RD_SPEEDRUN_ACC_LABRUINS"},
	// {, , "RD_SPEEDRUN_ACC_COMPLEX"},
	// {, , "RD_CAMPAIGN_NO_DEATHS_ACC"},
	// {, , "RD_EASY_CAMPAIGN_ADA"},
	// {, , "RD_NORMAL_CAMPAIGN_ADA"},
	// {, , "RD_HARD_CAMPAIGN_ADA"},
	// {, , "RD_INSANE_CAMPAIGN_ADA"},
	// {, , "RD_IMBA_CAMPAIGN_ADA"},
	// {, , "RD_SPEEDRUN_ADA_SECTOR_A9"},
	// {, , "RD_SPEEDRUN_ADA_NEXUS_SUBNODE"},
	// {, , "RD_SPEEDRUN_ADA_NEON_CARNAGE"},
	// {, , "RD_SPEEDRUN_ADA_FUEL_JUNCTION"},
	// {, , "RD_SPEEDRUN_ADA_DARK_PATH"},
	// {, , "RD_SPEEDRUN_ADA_FORBIDDEN_OUTPOST"},
	// {, , "RD_SPEEDRUN_ADA_NEW_BEGINNING"},
	// {, , "RD_SPEEDRUN_ADA_ANOMALY"},
	// {, , "RD_CAMPAIGN_NO_DEATHS_ADA"},
	// {, , "RD_DIE_IN_MANY_WAYS"},
}
